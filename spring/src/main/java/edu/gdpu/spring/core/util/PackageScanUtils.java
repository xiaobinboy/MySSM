    ...
    public static Set<Class> scanAllClasses(String packageName) {
        ...
        try {
            ...
            while (resources.hasMoreElements()) {
                URL url = resources.nextElement();//自动从class文件所在的目录读取
                // System.out.println("url:"+url);//url:file:/D:/javaprogram/springboot_quick/MySSM/spring/target/classes/edu/gdpu/myspring/beans
